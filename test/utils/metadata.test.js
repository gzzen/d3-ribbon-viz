...
beforeEach(async () => {
	const mod = await import('../../src/utils/metadata.js');
	mod._reset();
});
...
describe('metadata', () => {
	...
	describe('before init()', () => {
		it('getAttrLabel throws', async () => {
			const { getAttrLabel } = await import('../../src/utils/metadata.js');
			expect(() => getAttrLabel('age')).toThrow('metadata.init()');
		});

		it('getAttrType throws', async () => {
			const { getAttrType } = await import('../../src/utils/metadata.js');
	...
	describe('after init()', () => {
		beforeEach(async () => {
			...
			const { init } = await import('../../src/utils/metadata.js');
			await init('test-url');
		});
		...
		it('getLabel returns value unchanged for numeric', async () => {
			const { getLabel } = await import('../../src/utils/metadata.js');
		...
		it('getCategories returns null for numeric', async () => {
			const { getCategories } = await import('../../src/utils/metadata.js');
		...
		it('getNumericRange returns null for non-numeric', async () => {
			const { getNumericRange } = await import('../../src/utils/metadata.js');
